    ...
    <AlertContext.Provider value={{ showAlert }}>
      ...
      {alertData && (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-[fadeIn_0.2s_ease-out]">
          <div className="bg-card border border-subtle rounded-3xl p-6 max-w-sm w-full shadow-2xl relative overflow-hidden transform transition-all">
            ...
            <div className="flex flex-col items-center text-center z-10 relative">
              ...
              <h3 className="text-lg font-bold text-heading mb-2">Atenção</h3>
              <p className="text-body text-sm mb-6 whitespace-pre-line">{alertData.message}</p>
              <button 
                onClick={closeAlert}
