  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4">
      <div className="relative flex items-center justify-center w-24 h-24 mb-6">
        ...
        <div className="w-8 h-8 bg-primary rounded-full shadow-[0_0_20px_rgba(99,102,241,1)] flex items-center justify-center">
          <div className="w-3 h-3 bg-white rounded-full"></div>
        </div>
      </div>
      <p className="text-zinc-300 font-medium tracking-wide animate-pulse text-lg">{message}</p>
    </div>
  );
}
